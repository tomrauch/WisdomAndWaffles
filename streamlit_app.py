    ...
    st.markdown(
        ...
        <div style='text-align: center; padding: 20px;'>
            ...
            <p style='font-size: 18px; color: #555;'>
                A diner for ideas — where perspectives from across the political spectrum come together to spark understanding, encourage civil debate, and find common ground.
            </p>
        </div>
        """,
